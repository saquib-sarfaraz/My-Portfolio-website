  ...
  return (
    <section id="experience" ref={containerRef} className="py-24 px-4 sm:px-6 relative bg-[#0B0F2A] text-left overflow-hidden">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="relative ml-4 sm:ml-8 pl-8 sm:pl-12 space-y-8">
          ...
          {timelineData.map((exp, idx) => {
            ...
            return (
              ...
              >
                {/* Node Dot / Marker */}
                <div
                  className={`absolute -left-[41px] sm:-left-[57px] top-6 w-7 h-7 rounded-full border-2 transition-all flex items-center justify-center z-10 ${
                    isPinned
                ...
                {/* Node Card Box */}
                <div
                  className={`p-6 sm:p-8 rounded-3xl transition-all cursor-pointer shadow-lg ${
                    isPinned
                      ? 'bg-[#0F173A] border-2 border-emerald-500/60 shadow-2xl shadow-emerald-500/10 relative overflow-hidden'
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-4 border-b border-slate-700/80 pb-4">
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        <span className="text-[11px] font-mono text-slate-200 font-semibold px-2.5 py-0.5 rounded bg-slate-800">
                          {exp.type}
                        </span>
                        <span
                      ...
                      <h3 className="text-2xl sm:text-3xl font-extrabold text-white pt-1">{exp.title}</h3>
                      <div className="text-slate-200 font-medium flex items-center gap-2 text-sm font-mono">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-xs font-mono text-slate-300 px-3.5 py-1.5 rounded-xl bg-slate-800 border border-slate-700 flex items-center gap-1.5">
                    ...
                    >
                      ...
                      <div className="space-y-2 text-xs sm:text-sm text-slate-200">
                        {exp.impactBullets.map((bullet, bIdx) => (
                          <div key={bIdx} className="flex items-start gap-3 leading-relaxed">
                            <CheckCircle2
